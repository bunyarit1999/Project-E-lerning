...
แก้ไขข้อมูลผู้ใช้งานนักเรียน</H4>
        <hr>
        <form method="post">
        ...
        <input type="hidden" name="id" value="<?php echo $row['student_id']?>">  
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" type="text"name="student_surname" value="<?php echo $row['student_surname']?>" placeholder="ป้อนนามสกุล" required>
            </div>

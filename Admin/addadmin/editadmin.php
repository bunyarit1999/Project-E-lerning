  ...
  */
    ...
    if(isset($_POST['submit'])){
        ...
        try { 
            ...
            $stmt = $conn->prepare("UPDATE admins SET username = :username, prefix = :prefix, admin_name = :admin_name,
            admin_surname = :admin_surname WHERE admin_id = :admin_id");
...
แก้ไขข้อมูลผู้ใช้งานผู้ดูแล</H4>
        <hr>
        <form method="post">
        ...
        <input type="hidden" name="id" value="<?php echo $row['admin_id']?>">  
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" type="text"name="admin_name" value="<?php echo $row['admin_name']?>" placeholder="ป้อนชื่อ" required>
            </div>
            
            <div class="form-group mb-3">
                <label for="admin_surname" class="form-label">นามสกุล</label>
                <input class="form-control" type="text"name="admin_surname" value="<?php echo $row['admin_surname']?>" placeholder="ป้อนนามสกุล" required>
            </div>

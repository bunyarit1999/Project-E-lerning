...
<h4><i class="fas fa-table"></i> ตารางแสดงรายชื่อข้อมูลผู้ใช้งานอาจารย์</h4>
    <hr>
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <td>
            <form action="">
            <td><a class="btn btn-warning" href="editteacher.php?id=<?=$row->teacher_id?>">แก้ไขข้อมูล</a>
            <button type='button' class="btn btn-danger" id='deleteItem' data-id="<?=$row->teacher_id?>">ลบข้อมูล</button>
            </form>
            </td> 

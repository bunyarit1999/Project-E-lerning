...
<body>
    ...
    <a href="showlesson.php"><i class="fa-solid fa-book-open"></i> เลือกบทเรียน</a>
...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
                ...
                <div class="d-block w-100" alt="..." class="card border-dark mb-3">
                    <img src="../Teacher/addlesson/upload/<?php echo $row['image']; ?>" class="card-img-top" alt="...">
                    <div class="card-footer">
                        <h3 class="card-body"> <u> <?php echo $row['topic_name']; ?> </u>  </h3>
                    </div>
                    <div class="card-body">
                        <h4><pre><?php echo $row['content']; ?></pre></h4>
                    </div>
                </div>

...
<head>
    ...
    <title>ตารางข้อมูลผู้ใช้งานนักเรียน</title>
</head>
<body>
<!-- sidebar -->
...
<h4><i class="fas fa-table"></i> ตารางแสดงรายชื่อข้อมูลผู้ใช้งานนักเรียน <a class="btn btn-primary" href="addstudent.php"> เพิ่มข้อมูลผู้ใช้งานนักเรียน <a> </h4> 
    <hr>
    <table class="table table-bordered" id="example">
        ...
        <tr>
            ...
            <form action="">
                <td> <a class="btn btn-warning" href="editstudent.php?id=<?=$row->student_id?>">แก้ไขข้อมูล</a>
                <button type='button' class="btn btn-danger" id='deleteItem' data-id="<?=$row->student_id?>">ลบข้อมูล</button>
                </form>
            </td> 
        </tr>
        <?php

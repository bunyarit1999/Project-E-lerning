...
<div id="mySidenav" class="sidenav"> 
    ...
    <a class="dropdown-toggle" href="#" id="Menulogin" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-user-plus"></i>
    ข้อมูลผู้ใช้งาน</a>
    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="Menulogin">
        <a class="dropdown-item" href="addstudent/student-username-table.php">จัดการข้อมูลนักเรียน</a>
    </ul>

    <a class="dropdown-toggle" href="#" id="Menulogin" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa-solid fa-book"></i>
    ข้อมูลบทเรียน</a>
    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="Menulogin">
    ...
    <section id="carouselExampleIndicators" class="container carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="../img/Teacher/Photo01.jpg" alt="Image">
      ...
      <section class="py-5 bg-white text-center">
        <div class="container">
            <h3>เพิ่ม/ลบ/แก้ไข/ตรวจสอบ ข้อมูลผู้นักเรียน , การจัดการบทเรียน </h3>
        </div>
    </section>
    ...
    <section class="container mb-5">
        <div class="row g-3">
            ...
            <div class="col-12 text-center py-3">
                <h3>ชื่อ : <?php echo $_SESSION['prefix'].' '.$_SESSION['teacher_name'].' '.$_SESSION['teacher_surname']; ?></h3>

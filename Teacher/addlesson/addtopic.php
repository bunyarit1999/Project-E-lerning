  ...
  if($_SERVER['REQUEST_METHOD'] === 'POST') {    
    try {
        ...
        if (empty($image_file)) {
            ...
            header("Refresh:0; url=addtopic.php?id=$lesson_id"); 
            $errorMsg = " ";
        ...
        // ---------------- 
            ...
            $stmt = $conn->prepare("INSERT INTO topic(topic_name, content, image, lesson_id) 
            VALUES(:topic_name,:content,:image,:lesson_id)");
...
<html lang="en">
<head>
<title>เพิ่มเนื้อหาบทเรียน</title>
...
<h4><i class="fas fa-file-signature"></i> เพิ่มเนื้อหาบทเรียน </h4>
    <hr>
    ...
    <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                ...
                <input class="form-control" type="number" name="lesson_id" value="<?php echo $lesson_id?>"required>
            </div>

            <div class="form-group mb-3">
                <label for="topic_name" class="form-label">ชื่อหัวข้อ</label>
                <input class="form-control" type="text" name="topic_name" placeholder="กรุณาใส่หัวข้อ ... " required>
            </div>

            <div class="form-group mb-3">
                <label for="content" class="form-label">เนื้อหา</label>
                <textarea class="form-control" type="text" name="content" rows="10"  placeholder="กรุณาใส่เนื้อหา ... " required></textarea>
            </div>
            ...
            <div class="d-grid gap-2 col-6 mx-auto">
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        ยืนยันการเพิ่มข้อมูลหัวข้อหรือไม่
                    </div>
